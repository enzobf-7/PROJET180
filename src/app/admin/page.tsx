...
export default function AdminPage() {
  ...
  return (
    <div className="min-h-screen bg-[#060606] text-[#F5F5F5]">
      ...
      <main className="relative max-w-4xl mx-auto px-4 py-10 space-y-12">
        ...
        <section className="space-y-4">
          <div className="space-y-1">
            ...
            <p className="text-sm text-[#484848]">
              Vue d&apos;ensemble de tes clients actifs et formulaire d&apos;ajout.
            </p>
          </div>
          ...
          <form
            ...
            className="rounded-2xl border border-[#1E1E1E] bg-[#0F0F0F] p-6 space-y-4"
          >
            <p className="text-xs font-black uppercase tracking-[0.18em] text-[#484848]">Ajouter un client</p>
        ...
        {/* ── Section 2 : Habits CRUD ── */}
        <section className="space-y-4">
          <div className="space-y-1">
            <h2 className="text-xl font-black tracking-tight">Missions / Habits</h2>
            <p className="text-sm text-[#484848]">
              Gère les habits quotidiens de chaque client.
            </p>
          </div>
        ...
        {/* ── Section 3 : Config onboarding ── */}
        <section className="space-y-4">
          <div className="space-y-1">
            <h2 className="text-xl font-black tracking-tight">Onboarding & accès clients</h2>
            <p className="text-sm text-[#484848]">
              WhatsApp, Skool, lien de call et contrat PDF.
            </p>
          </div>
          ...
          >
            ...
            <div className="flex justify-end">
              ...
              >
                {savingSettings ? 'Enregistrement…' : 'Enregistrer les changements'}
              </button>
            </div>
          </form>
        </section>
        ...
        <section className="space-y-4">
          <div className="space-y-1">
            ...
            <p className="text-sm text-[#484848]">Accède aux différentes sections de gestion.</p>
          </div>
